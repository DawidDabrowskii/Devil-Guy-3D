...
public class WallMovable : MonoBehaviour
{
	...
	public bool isRandom = true; // jesli chcemy, aby sciana upadala losowo
	public float speed = 2f;

	private float height; // wysokosc platformy
	private float posYDown; // startowa pozycja Y
	...
	//funkcja czeka czy isc w gore czy w dol
	IEnumerator WaitToChange(float time)
	{
		...
		if (isRandom && !isDown) //losowa pozycja sciany
		{
	...
	//funkcja, ktora sprawdza co 1.25 czy sciana zostala tknieta
